...
instructions = (
    (7, re.compile(r"^adc$")),
    (7, re.compile(r"^and$")),
    (7, re.compile(r"^(?:as|ro)l$")),
    (1, re.compile(r"^bit$")),
    (1, re.compile(r"^(cl[cv]|sec)$")),
    (1, re.compile(r"^cp[xy]$")),
    (1, re.compile(r"^cmp$")),
    (35, re.compile(r"^de[cxy]$")),
    (7, re.compile(r"^eor$")),
    (35, re.compile(r"^in[cxy]$")),
    (14, re.compile(r"^lda$")),
    (14, re.compile(r"^ld[xy]$")),
    (7, re.compile(r"^(?:ls|ro)r$")),
    (1, re.compile(r"^nop$")),
    (7, re.compile(r"^ora$")),
    (7, re.compile(r"^sbc$")),
    (35, re.compile(r"^sta$")),
    (35, re.compile(r"^st[xy]$")),
    (34, re.compile(r"^t[saxy][axy]$")),
)
